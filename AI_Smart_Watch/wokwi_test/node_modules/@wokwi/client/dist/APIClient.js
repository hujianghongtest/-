...
import { PausePoint } from './PausePoint.js';
export class APIClient {
    ...
    async touchEvent(partId, x, y, event, options) {
    ...
    async readVCD() {
        return await this.sendCommand('sim:read-vcd');
    }
    ...
    async waitForChipOutput(text) {
        return new Promise((resolve) => {
            const listener = this.listen('chips:log', (event) => {
